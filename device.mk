...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/audio_policy_configuration_ZC600KL.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_configuration_ZC600KL.xml \
    $(LOCAL_PATH)/configs/audio/audio_policy_configuration_ZC600KL_24bit.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_configuration_ZC600KL_24bit.xml \
    $(LOCAL_PATH)/configs/audio/audio_policy_volumes.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_volumes.xml \
    $(LOCAL_PATH)/configs/audio/audio_policy_volumes_ZC600KL.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_volumes_ZC600KL.xml \
    ...
    $(LOCAL_PATH)/configs/audio/mixer_paths_ZC600KL.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_ZC600KL.xml \
    $(LOCAL_PATH)/configs/audio/mixer_paths_ZC600KL_24bit.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_ZC600KL_24bit.xml \
    $(LOCAL_PATH)/configs/audio/mixer_paths_ZC600KL_EU.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_ZC600KL_EU.xml \
    $(LOCAL_PATH)/configs/audio/mixer_paths_ZC600KL_EU_24bit.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_ZC600KL_EU_24bit.xml \
...
# Inherit vendor
$(call inherit-product, vendor/asus/X017D_2/X017D_2-vendor.mk)